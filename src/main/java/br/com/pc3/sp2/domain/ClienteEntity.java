...
public class ClienteEntity implements Serializable {
    public static final long serialVersionUID = 4239998179114264115L;
    @Id
    @Length(message = "Digite o cpf.", min = 11, max = 14)
    @Pattern(message = "Digite um cpf valido.", regexp = "([0-9]{2}[.]?[0-9]{3}[.]?[0-9]{3}[.]?[0-9]{4}[-]?[0-9]{2})|([0-9]{3}[.]?[0-9]{3}[.]?[0-9]{3}[-]?[0-9]{2})")
