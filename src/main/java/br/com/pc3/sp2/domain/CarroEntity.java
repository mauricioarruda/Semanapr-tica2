...
public class CarroEntity implements Serializable {
    public static final long serialVersionUID = 1048537080755495841L;
    @Id
    @Length(message = "Digite a placa", min = 7, max = 7)
    @NotNull(message = "Campo obrigatorio")
    @Pattern(message = "Neste modelo.", regexp = "[A-Z]{2,3}[0-9]{4}|[A-Z]{3,4}[0-9]{3}|[A-Z0-9]{7}")
